...
class CURLRequest(object):
    ...
    def __init__(self, request, timeout=None, verify=None, cert=None, verbose=0,cipher_list=None):
    ...
    def set_cipher(self):
        ...
        return ','.join(self._CIPHER_LIST or CIPHER_LIST or [])
